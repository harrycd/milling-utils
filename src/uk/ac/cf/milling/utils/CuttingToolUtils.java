...
public class CuttingToolUtils {
	 ...
	 */
	public static int addCuttingTool(String toolName, String toolType, int toolTeeth, double toolLength){
		return new CuttingToolDB().addCuttingTool(toolName, toolType, toolTeeth, toolLength);
	}
	 ...
	 */
	public static void updateCuttingTool(int toolId, String toolName, String toolType, int toolTeeth, double toolLength ) {
		new CuttingToolDB().updateCuttingTool(toolId, toolName, toolType, toolTeeth, toolLength);
	}
